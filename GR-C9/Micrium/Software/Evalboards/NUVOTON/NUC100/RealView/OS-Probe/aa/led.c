...
//	        Dsp_Send_Data(0xFF,G_SENCE_WT,127,147,D_NON);  
//			Scen_Send(0xD7,127) ; 		     
//            Scen_Send(0xDA,127) ; 		     
//            Scen_Send(0xD9,127) ; 			 
//			Scen_Send(0xD8,127) ;			 
	...
	//	if(System.Led.Statu != DB_UV_ON  )
		{
			...
			Scen_Send(G_SENCE_WT,0x00);
		//	OSTimeDly(20); 
		        Dsp_Send_Data(0xFF,G_SENCE_DB_UV,81,109,D_NON); //白平衡
	//			Scen_Send(0xD7,218) ; 		    //锐度
	//	        Scen_Send(0xDA,127) ; 		    //对比度
	//	        Scen_Send(0xD9,207) ; 			//亮度
	//			Scen_Send(0xD8,127) ;				//饱和度
		        Dsp_Send_Data(0xFB,G_SENCE_DB_UV,90,90,D_NON); //曝光度
		        Dsp_Send_Data(0xFC,G_SENCE_DB_UV,25,25,D_NON); //曝光时间
...
//	    Scen_Send(G_SENCE_WT,0x00);
//        Dsp_Send_Data(0xFF,G_SENCE_WT,112,142,D_NON); //白平衡
//		Scen_Send(0xD7,127) ; 		    //锐度
//        Scen_Send(0xDA,127) ; 		    //对比度
...
//		    OSTimeDly(30); 
			...
			Scen_Send(0xD9,127) ; 			//亮度
			Scen_Send(0xD8,127) ;				//饱和度
			Dsp_Send_Data(0xFB,G_SENCE_WT,120,120,D_NON); //曝光度
			Dsp_Send_Data(0xFC,G_SENCE_WT,50,50,D_NON); //曝光时间
			Scen_Send(G_SENCE_WT,0x03);
